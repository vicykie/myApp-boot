...
public class UserAuthTokenHandler {
    @Value(value = "${myapp.security.key}")
    private String SECURITY_KEY = "vicykie";
    ...
    public UserInfo parseToken(String token) {
        ...
        user.setRoleInfo((RoleInfo) claims.get(CLAIMS_ROLES));
        return user;
    }
...
//        final Date expiration = this.getExpirationDateFromToken(token);
    ...
    public static void main(String[] args) {
        UserAuthTokenHandler t = new UserAuthTokenHandler();
        ...
        UserInfo user = t.parseToken(token);
